...
public class MessageToElasticSearchJsonV1 implements MessageToElasticSearchJson {
    ...
    public MessageToElasticSearchJsonV1(TextExtractor textExtractor, ZoneId zoneId, IndexAttachments indexAttachments) {
