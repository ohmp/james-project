...
public class ElasticSearchSearcherV1 implements ElasticSearchSearcher {

    private static final Logger LOGGER = LoggerFactory.getLogger(ElasticSearchSearcherV1.class);
    ...
    @Inject
    public ElasticSearchSearcherV1(Client client, QueryConverter queryConverter,
    ...
    public ElasticSearchSearcherV1(Client client, QueryConverter queryConverter, int size,
                                   MailboxId.Factory mailboxIdFactory, MessageId.Factory messageIdFactory,
