...
import static org.apache.james.backends.es.NodeMappingFactory.STANDARD;
...
public class MailboxMappingFactoryV2 implements MailboxMappingFactory {

    private static final int MAXIMUM_TERM_LENGTH = 4096;
    private static final String STANDARD = "standard";

    public XContentBuilder getMappingContent() {
        try {
            return jsonBuilder()
                .startObject()
                    ...
                    .startObject(MailboxElasticSearchConstants.MESSAGE_TYPE.getValue())
                        .startObject(PROPERTIES)
                            ...
                            .field(TYPE, STRING)
                            .field(ANALYZER, STANDARD)
                            .field(NodeMappingFactory.SEARCH_ANALYZER, KEEP_MAIL_AND_URL)
                            .startObject(FIELDS)
                            .startObject(RAW)
                            .field(TYPE, STRING)
                            .field(ANALYZER, CASE_INSENSITIVE)
                            ...
                            .field(ANALYZER, KEEP_MAIL_AND_URL)
                            .startObject(FIELDS)
                            .startObject(NodeMappingFactory.SPLIT_EMAIL)
                            .field(TYPE, STRING)
                            .field(ANALYZER, STANDARD)
                            .field(SEARCH_ANALYZER, KEEP_MAIL_AND_URL)
                            .endObject()
