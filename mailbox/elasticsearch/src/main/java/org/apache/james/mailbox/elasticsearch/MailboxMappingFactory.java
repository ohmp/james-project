                ...
                .startObject()
                    ...
                    .startObject(PROPERTIES)
                        ...
                        .startObject(FROM + EMailer.NAME)
                            ...
                            .endObject()
                        .endObject()
                        .startObject(FROM + EMailer.ADDRESS)
                            .field(TYPE, TEXT)
                        ...
                        .startObject(TO + EMailer.NAME)
                            ...
                            .endObject()
                        .endObject()
                        .startObject(TO + EMailer.ADDRESS)
                            .field(TYPE, TEXT)
                            .field(ANALYZER, STANDARD)
                            .field(SEARCH_ANALYZER, KEEP_MAIL_AND_URL)
                            .startObject(FIELDS)
                        ...
                        .startObject(CC + EMailer.NAME)
                            ...
                            .endObject()
                        .endObject()
                        .startObject(CC + EMailer.ADDRESS)
                            .field(TYPE, TEXT)
                            .field(ANALYZER, STANDARD)
                            .field(SEARCH_ANALYZER, KEEP_MAIL_AND_URL)
                            .startObject(FIELDS)
                        ...
                        .startObject(BCC + EMailer.NAME)
                            ...
                            .endObject()
                        .endObject()
                        .startObject(BCC + EMailer.ADDRESS)
                            .field(TYPE, TEXT)
                            .field(ANALYZER, STANDARD)
                            .field(SEARCH_ANALYZER, KEEP_MAIL_AND_URL)
                            .startObject(FIELDS)
