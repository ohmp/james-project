...
public class MessageToElasticSearchJsonTest {
    ...
    private static final ImmutableList<User> USERS = ImmutableList.of(User.fromUsername("username"));
    ...
    public void spamEmailShouldBeWellConvertedToJson() throws IOException {
        ...
        assertThatJson(messageToElasticSearchJson.convertToJson(spamMail, USERS))
    ...
    public void htmlEmailShouldBeWellConvertedToJson() throws IOException {
        ...
        htmlMail.setUid(UID);
        assertThatJson(messageToElasticSearchJson.convertToJson(htmlMail, USERS))
            .when(IGNORING_ARRAY_ORDER)
    ...
    public void pgpSignedEmailShouldBeWellConvertedToJson() throws IOException {
        ...
        assertThatJson(messageToElasticSearchJson.convertToJson(pgpSignedMail, USERS))
            .when(IGNORING_ARRAY_ORDER)
    ...
    public void recursiveEmailShouldBeWellConvertedToJson() throws IOException {
        ...
        assertThatJson(messageToElasticSearchJson.convertToJson(recursiveMail, USERS))
            .when(IGNORING_ARRAY_ORDER).when(IGNORING_VALUES)
    ...
    public void emailWithNoInternalDateShouldUseNowDate() throws IOException {
        ...
        assertThatJson(messageToElasticSearchJson.convertToJson(mailWithNoInternalDate, USERS))
            .when(IGNORING_ARRAY_ORDER)
    ...
    public void emailWithAttachmentsShouldConvertAttachmentsWhenIndexAttachmentsIsTrue() throws IOException {
        ...
        String convertToJson = messageToElasticSearchJson.convertToJson(mailWithNoInternalDate, USERS);
    ...
    public void emailWithNoMailboxIdShouldThrow() {
        ...
        assertThatThrownBy(() ->
            messageToElasticSearchJson.convertToJson(mailWithNoMailboxId, USERS))
    ...
    public void convertToJsonWithoutAttachmentShouldConvertEmailBoby() throws IOException {
        ...
        MessageToElasticSearchJson messageToElasticSearchJson = new MessageToElasticSearchJson(
                ...
                ZoneId.of("Europe/Paris"),
                IndexAttachments.NO);
        String convertToJsonWithoutAttachment = messageToElasticSearchJson.convertToJsonWithoutAttachment(message, USERS);
