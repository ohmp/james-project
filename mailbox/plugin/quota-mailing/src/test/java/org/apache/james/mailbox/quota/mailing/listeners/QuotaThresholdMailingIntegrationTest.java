...
public interface QuotaThresholdMailingIntegrationTest {
    ...
    default void shouldNotSendMailWhenNoThresholdUpdate(EventStore store) throws Exception {
        FakeMailContext mailetContext = mailetContext();
        QuotaThresholdListenersTestSystem testee = new QuotaThresholdListenersTestSystem(mailetContext, store, DEFAULT_CONFIGURATION);
        testee.event(new QuotaUsageUpdatedEvent(EVENT_ID, BOB_USER, QUOTAROOT, Counts._40_PERCENT, Sizes._55_PERCENT, ONE_HOUR_AGO));
    ...
    default void shouldNotSendMailWhenThresholdOverPassedRecently(EventStore store) throws Exception {
        FakeMailContext mailetContext = mailetContext();
        QuotaThresholdListenersTestSystem testee = new QuotaThresholdListenersTestSystem(mailetContext, store, DEFAULT_CONFIGURATION);
        testee.event(new QuotaUsageUpdatedEvent(EVENT_ID, BOB_USER, QUOTAROOT, Counts._40_PERCENT, Sizes._55_PERCENT, TWELVE_HOURS_AGO));
        testee.event(new QuotaUsageUpdatedEvent(EVENT_ID, BOB_USER, QUOTAROOT, Counts._40_PERCENT, Sizes._30_PERCENT, SIX_HOURS_AGO));
        mailetContext.resetSentMails();
    ...
    default void shouldNotifySeparatelyCountAndSize(EventStore store) throws Exception {
        ...
        testee.event(new QuotaUsageUpdatedEvent(EVENT_ID, BOB_USER, QUOTAROOT, Counts._52_PERCENT, Sizes._60_PERCENT, NOW));
    ...
    default void shouldGroupSizeAndCountNotificationsWhenTriggeredByASingleEvent(EventStore store) throws Exception {
        ...
        testee.event(new QuotaUsageUpdatedEvent(EVENT_ID, BOB_USER, QUOTAROOT, Counts._52_PERCENT, Sizes._55_PERCENT, NOW));
    ...
    default void shouldSendMailWhenThresholdOverPassedOverGracePeriod(EventStore store) throws Exception {
        FakeMailContext mailetContext = mailetContext();
        QuotaThresholdListenersTestSystem testee = new QuotaThresholdListenersTestSystem(mailetContext, store, DEFAULT_CONFIGURATION);
        testee.event(new QuotaUsageUpdatedEvent(EVENT_ID, BOB_USER, QUOTAROOT, Counts._40_PERCENT, Sizes._55_PERCENT, TWELVE_DAYS_AGO));
        testee.event(new QuotaUsageUpdatedEvent(EVENT_ID, BOB_USER, QUOTAROOT, Counts._40_PERCENT, Sizes._30_PERCENT, SIX_DAYS_AGO));
        mailetContext.resetSentMails();
    ...
    default void shouldNotSendMailWhenNoThresholdUpdateForCount(EventStore store) throws Exception {
        FakeMailContext mailetContext = mailetContext();
        QuotaThresholdListenersTestSystem testee = new QuotaThresholdListenersTestSystem(mailetContext, store, DEFAULT_CONFIGURATION);
        testee.event(new QuotaUsageUpdatedEvent(EVENT_ID, BOB_USER, QUOTAROOT, Counts._32_PERCENT, Sizes._55_PERCENT, TWO_DAYS_AGO));
        mailetContext.resetSentMails();

        testee.event(new QuotaUsageUpdatedEvent(EVENT_ID, BOB_USER, QUOTAROOT, Counts._40_PERCENT, Sizes._60_PERCENT, TWO_DAYS_AGO));
    ...
    default void shouldNotSendMailWhenThresholdOverPassedRecentlyForCount(EventStore store) throws Exception {
        FakeMailContext mailetContext = mailetContext();
        QuotaThresholdListenersTestSystem testee = new QuotaThresholdListenersTestSystem(mailetContext, store, DEFAULT_CONFIGURATION);
        testee.event(new QuotaUsageUpdatedEvent(EVENT_ID, BOB_USER, QUOTAROOT, Counts._52_PERCENT, Sizes._30_PERCENT, TWELVE_HOURS_AGO));
        testee.event(new QuotaUsageUpdatedEvent(EVENT_ID, BOB_USER, QUOTAROOT, Counts._40_PERCENT, Sizes._30_PERCENT, SIX_HOURS_AGO));
        mailetContext.resetSentMails();

        testee.event(new QuotaUsageUpdatedEvent(EVENT_ID, BOB_USER, QUOTAROOT, Counts._52_PERCENT, Sizes._30_PERCENT, NOW));
    ...
    default void shouldSendMailWhenThresholdOverPassedOverGracePeriodForCount(EventStore store) throws Exception {
        FakeMailContext mailetContext = mailetContext();
        QuotaThresholdListenersTestSystem testee = new QuotaThresholdListenersTestSystem(mailetContext, store, DEFAULT_CONFIGURATION);
        testee.event(new QuotaUsageUpdatedEvent(EVENT_ID, BOB_USER, QUOTAROOT, Counts._52_PERCENT, Sizes._30_PERCENT, TWELVE_DAYS_AGO));
        testee.event(new QuotaUsageUpdatedEvent(EVENT_ID, BOB_USER, QUOTAROOT, Counts._40_PERCENT, Sizes._30_PERCENT, SIX_DAYS_AGO));
        mailetContext.resetSentMails();
    ...
    default void shouldSendOneNoticePerThreshold(EventStore store) throws Exception {
        ...
        testee.event(new QuotaUsageUpdatedEvent(EVENT_ID, BOB_USER, QUOTAROOT, Counts._52_PERCENT, Sizes._30_PERCENT, NOW));
        testee.event(new QuotaUsageUpdatedEvent(EVENT_ID, BOB_USER, QUOTAROOT, Counts._85_PERCENT, Sizes._42_PERCENT, NOW));
    ...
    default void shouldSendOneMailUponConcurrentEvents(EventStore store) throws Exception {
        ...
        ConcurrentTestRunner.builder()
            .operation((threadNb, step) -> testee.event(new QuotaUsageUpdatedEvent(EVENT_ID, BOB_USER, QUOTAROOT, Counts._40_PERCENT, Sizes._55_PERCENT, NOW)))
            .threadCount(10)
