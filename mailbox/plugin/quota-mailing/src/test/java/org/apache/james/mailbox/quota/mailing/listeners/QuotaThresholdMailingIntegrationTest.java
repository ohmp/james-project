...
public interface QuotaThresholdMailingIntegrationTest {
    ...
    default void shouldNotSendMailWhenNoThresholdUpdate(EventStore store) throws Exception {
        ...
        testee.event(new QuotaUsageUpdatedEvent(BOB_SESSION, QUOTAROOT, Counts._40_PERCENT, Sizes._55_PERCENT, BASE_INSTANT));
    ...
    default void shouldNotSendMailWhenThresholdOverPassedRecently(EventStore store) throws Exception {
        ...
        testee.event(new QuotaUsageUpdatedEvent(BOB_SESSION, QUOTAROOT, Counts._40_PERCENT, Sizes._55_PERCENT, BASE_INSTANT.minus(Duration.ofHours(12))));

        testee.event(new QuotaUsageUpdatedEvent(BOB_SESSION, QUOTAROOT, Counts._40_PERCENT, Sizes._30_PERCENT, BASE_INSTANT.minus(Duration.ofHours(6))));
    ...
    default void shouldNotifySeparatelyCountAndSize(EventStore store) throws Exception {
        ...
        testee.event(new QuotaUsageUpdatedEvent(BOB_SESSION, QUOTAROOT, Counts._52_PERCENT, Sizes._60_PERCENT, BASE_INSTANT));
    ...
    default void shouldGroupSizeAndCountNotificationsWhenTriggeredByASingleEvent(EventStore store) throws Exception {
        ...
        testee.event(new QuotaUsageUpdatedEvent(BOB_SESSION, QUOTAROOT, Counts._52_PERCENT, Sizes._55_PERCENT, BASE_INSTANT));
    ...
    default void shouldSendMailWhenThresholdOverPassedOverGracePeriod(EventStore store) throws Exception {
        ...
        testee.event(new QuotaUsageUpdatedEvent(BOB_SESSION, QUOTAROOT, Counts._40_PERCENT, Sizes._55_PERCENT,
            BASE_INSTANT.minus(Duration.ofDays(12))));
        testee.event(new QuotaUsageUpdatedEvent(BOB_SESSION, QUOTAROOT, Counts._40_PERCENT, Sizes._30_PERCENT,
    ...
    default void shouldNotSendMailWhenNoThresholdUpdateForCount(EventStore store) throws Exception {
        ...
        testee.event(new QuotaUsageUpdatedEvent(BOB_SESSION, QUOTAROOT, Counts._32_PERCENT, Sizes._55_PERCENT,
            BASE_INSTANT.minus(Duration.ofDays(2))));

        mailetContext.resetSentMails();

        testee.event(new QuotaUsageUpdatedEvent(BOB_SESSION, QUOTAROOT, Counts._40_PERCENT, Sizes._60_PERCENT,
            BASE_INSTANT.minus(Duration.ofDays(2))));
    ...
    default void shouldNotSendMailWhenThresholdOverPassedRecentlyForCount(EventStore store) throws Exception {
        ...
        testee.event(new QuotaUsageUpdatedEvent(BOB_SESSION, QUOTAROOT, Counts._52_PERCENT, Sizes._30_PERCENT,
    ...
    default void shouldSendOneNoticePerThreshold(EventStore store) throws Exception {
        ...
        testee.event(new QuotaUsageUpdatedEvent(
            BOB_SESSION, QUOTAROOT, Counts._52_PERCENT, Sizes._30_PERCENT, BASE_INSTANT));
        testee.event(new QuotaUsageUpdatedEvent(
            BOB_SESSION, QUOTAROOT, Counts._85_PERCENT, Sizes._42_PERCENT, BASE_INSTANT));
    ...
    default void shouldSendOneMailUponConcurrentEvents(EventStore store) throws Exception {
        ...
        new ConcurrentTestRunner(10, 1, (threadNb, step) ->
            testee.event(new QuotaUsageUpdatedEvent(
                BOB_SESSION, QUOTAROOT,
                Counts._40_PERCENT, Sizes._55_PERCENT,
                BASE_INSTANT)))
            .run()
