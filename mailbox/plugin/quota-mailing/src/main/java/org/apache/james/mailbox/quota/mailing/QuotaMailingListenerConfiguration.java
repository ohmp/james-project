...
public class QuotaMailingListenerConfiguration {
    ...
    public static final FileUrl DEFAULT_BODY_TEMPLATE = FileUrl.fromClasspath("templates/QuotaThresholdMailBody.mustache");
    public static final FileUrl DEFAULT_SUBJECT_TEMPLATE = FileUrl.fromClasspath("templates/QuotaThresholdMailSubject.mustache");
