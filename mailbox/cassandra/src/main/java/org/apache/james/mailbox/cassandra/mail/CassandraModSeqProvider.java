...
public class CassandraModSeqProvider implements ModSeqProvider {
    ...
    public CompletableFuture<Long> nextModSeq(CassandraId mailboxId) {
        return findHighestModSeq(mailboxId)
            ...
            .thenApply(optional -> optional.orElseThrow(() -> new ExceptionRelay(new MailboxException("Error during ModSeq update"))))
            .thenApply(ModSeq::getValue);
    }
