...
public interface CassandraMessageIdToImapUidDAOContract {
    ...
    default void deleteShouldNotThrowWhenRowDoesntExist() {
        messageIdToImapUidDAO().delete(messageIdFactory.of(UUIDs.timeBased()), CassandraId.timeBased())
            .join();
    }
    ...
    default void deleteShouldDeleteWhenRowExists() {
        ...
        messageIdToImapUidDAO().insert(ComposedMessageIdWithMetaData.builder()
        ...
        messageIdToImapUidDAO().delete(messageId, mailboxId).join();

        Stream<ComposedMessageIdWithMetaData> messages = messageIdToImapUidDAO().retrieve(messageId, Optional.of(mailboxId)).join();
    ...
    default void deleteShouldDeleteOnlyConcernedRowWhenMultipleRowExists() {
        ...
        ComposedMessageIdWithMetaData expectedComposedMessageId = ComposedMessageIdWithMetaData.builder()
                ...
                .modSeq(1)
                .build();
        Stream<ComposedMessageIdWithMetaData> messages = messageIdToImapUidDAO().retrieve(messageId, Optional.empty()).join();
    ...
    default void updateShouldReturnTrueWhenOldModSeqMatches() {
        ...
        ComposedMessageIdWithMetaData composedMessageIdWithFlags = ComposedMessageIdWithMetaData.builder()
                ...
                .modSeq(1)
                .build();
        messageIdToImapUidDAO().insert(composedMessageIdWithFlags).join();

        Boolean result = messageIdToImapUidDAO().updateMetadata(composedMessageIdWithFlags, 1).join();
    ...
    default void updateShouldReturnFalseWhenOldModSeqDoesntMatch() {
        ...
        Boolean result = messageIdToImapUidDAO().updateMetadata(composedMessageIdWithFlags, 3).join();
    ...
    default void updateShouldUpdateModSeq() {
        ...
        ComposedMessageIdWithMetaData expectedComposedMessageId = ComposedMessageIdWithMetaData.builder()
                ...
                .modSeq(2)
                .build();
        messageIdToImapUidDAO().updateMetadata(expectedComposedMessageId, 1).join();
