...
public class CassandraBasedRegisteredDistributedMailboxDelegatingListenerTest {
    ...
    private CassandraClusterSingleton cassandraClusterSingleton = CassandraClusterSingleton.build();
    ...
    public void setUp() throws Exception {
        ...
        publisherReceiver.register(registeredDelegatingMailboxListener1, mailboxPathRegister1.getLocalTopic());
        publisherReceiver.register(registeredDelegatingMailboxListener2, mailboxPathRegister2.getLocalTopic());
        publisherReceiver.register(registeredDelegatingMailboxListener3, mailboxPathRegister3.getLocalTopic());
