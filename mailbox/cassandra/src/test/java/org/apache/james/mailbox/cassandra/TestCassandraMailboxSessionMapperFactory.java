...
public class TestCassandraMailboxSessionMapperFactory {
    public static CassandraMailboxSessionMapperFactory forTests(Session session, CassandraTypesProvider typesProvider,
        ...
        CassandraObjectStore objectStore = new CassandraObjectStore(cassandraBlobsDAO);
        return new CassandraMailboxSessionMapperFactory(
            new CassandraUidProvider(session),
            new CassandraModSeqProvider(session),
            session,
            new CassandraMessageDAO(session, typesProvider, objectStore, blobIdFactory, CassandraUtils.WITH_DEFAULT_CONFIGURATION, factory),
            ...
            objectStore, new CassandraAttachmentMessageIdDAO(session, factory, CassandraUtils.WITH_DEFAULT_CONFIGURATION),
