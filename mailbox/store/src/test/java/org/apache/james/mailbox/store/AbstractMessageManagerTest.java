...
public abstract class AbstractMessageManagerTest {
    ...
    void getMetadataShouldListUsersAclWhenShared() throws Exception {
        ...
        MessageManager.MailboxContentMetaData actual = messageManager.getMetaData(NO_RESET_RECENT, aliceSession, MessageManager.MailboxContentMetaData.FetchGroup.NO_COUNT);
    ...
    void getMetadataShouldNotExposeOtherUsersWhenSessionIsNotOwner() throws Exception {
        ...
        MessageManager.MailboxContentMetaData actual = messageManager.getMetaData(NO_RESET_RECENT, bobSession, MessageManager.MailboxContentMetaData.FetchGroup.NO_COUNT);
