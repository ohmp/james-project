...
public abstract class AbstractCombinationManagerTest {
    ...
    void getMetadataFromMessageManagerShouldReturnRecentMessageWhenSetInMailboxesFromMessageIdManager() throws Exception {
        ...
        long mailbox2NextUid = messageManager2.getMetaData(true, session, MessageManager.MailboxContentMetaData.FetchGroup.UNSEEN_COUNT).getUidNext().asLong();
        ...
        List<MessageUid> messageUids = messageManager2.getMetaData(true, session, MessageManager.MailboxContentMetaData.FetchGroup.UNSEEN_COUNT).getRecent();
    ...
    void getMetadataFromMessageManagerShouldReturnNumberOfRecentMessageWhenSetInMailboxesFromMessageIdManager() throws Exception {
        ...
        assertThat(messageManager2.getMetaData(true, session, MessageManager.MailboxContentMetaData.FetchGroup.FIRST_UNSEEN).countRecent()).isEqualTo(1);
    }
    ...
    void getMetadataFromMessageManagerShouldReturnUidNextWhenSetInMailboxesFromMessageIdManager() throws Exception {
        ...
        assertThat(messageManager2.getMetaData(true, session, MessageManager.MailboxContentMetaData.FetchGroup.FIRST_UNSEEN).getUidNext().asLong())
            .isGreaterThan(uid2);
    }
    ...
    void getMetadataFromMessageManagerShouldReturnHighestModSeqWhenSetInMailboxesFromMessageIdManager() throws Exception {
        ...
        assertThat(messageManager2.getMetaData(true, session, MessageManager.MailboxContentMetaData.FetchGroup.FIRST_UNSEEN).getHighestModSeq().asLong()).isNotNegative();
    }
    ...
    void getMetadataFromMessageManagerShouldReturnMessageCountWhenSetInMailboxesFromMessageIdManager() throws Exception {
        ...
        assertThat(messageManager2.getMetaData(true, session, MessageManager.MailboxContentMetaData.FetchGroup.FIRST_UNSEEN).getMessageCount()).isEqualTo(1);
    }
    ...
    void getMetadataFromMessageManagerShouldReturnNumberOfUnseenMessageWhenSetInMailboxesFromMessageIdManager() throws Exception {
        ...
        assertThat(messageManager2.getMetaData(true, session, MessageManager.MailboxContentMetaData.FetchGroup.UNSEEN_COUNT).getUnseenCount()).isEqualTo(1);
    }
    ...
    void getMetadataFromMessageManagerShouldReturnFirstUnseenMessageWhenSetInMailboxesFromMessageIdManager() throws Exception {
        ...
        assertThat(messageManager2.getMetaData(true, session, MessageManager.MailboxContentMetaData.FetchGroup.FIRST_UNSEEN).getFirstUnseen()).isEqualTo(messageId.getUid());
    }
    ...
    void getMetadataFromMessageManagerShouldReturnNumberOfUnseenMessageWhenSetFlagsFromMessageIdManager() throws Exception {
        ...
        assertThat(messageManager1.getMetaData(true, session, MessageManager.MailboxContentMetaData.FetchGroup.UNSEEN_COUNT).getUnseenCount()).isEqualTo(1);
    }
    ...
    void getMetadataFromMessageManagerShouldReturnFirstUnseenMessageWhenSetFlagsFromMessageIdManager() throws Exception {
        ...
        assertThat(messageManager1.getMetaData(true, session, MessageManager.MailboxContentMetaData.FetchGroup.FIRST_UNSEEN).getFirstUnseen()).isEqualTo(messageId.getUid());
    }
