...
public class TestMailboxSessionMapperFactory extends MailboxSessionMapperFactory {
    ...
    public TestMailboxSessionMapperFactory() {
        ...
        messageIdMapper = new MessageIdMapper() {
            ...
            @Override
            public Map<MailboxId, UpdatedFlags> setFlags(final Flags newState, final MessageManager.FlagsUpdateMode updateMode, final MessageId messageId) throws MailboxException {
