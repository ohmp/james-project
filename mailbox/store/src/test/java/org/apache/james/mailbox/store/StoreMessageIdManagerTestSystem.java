...
public class StoreMessageIdManagerTestSystem extends MessageIdManagerTestSystem {
    ...
    public StoreMessageIdManagerTestSystem(MessageIdManager messageIdManager, Mailbox mailbox1, Mailbox mailbox2, Mailbox mailbox3,
        ...
        super(messageIdManager, mailbox1, mailbox2, mailbox3);
    ...
    public MessageId persist(MailboxId mailboxId, Flags flags) {
        ...
        try {
            mapperFactory.createMessageIdMapper(null).save(createMessage(mailboxId, flags, messageId));
            return messageId;
    ...
    private MailboxMessage createMessage(MailboxId mailboxId, Flags flags, MessageId messageId) {
