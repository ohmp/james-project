...
public class StoreMailboxManager implements MailboxManager {
    ...
    @Override
    public List<MessageManager> getMailboxes(Collection<MailboxId> mailboxIds, MailboxSession session) throws MailboxException {
        MailboxMapper mapper = mailboxSessionMapperFactory.getMailboxMapper(session);

        List<Mailbox> mailboxes = mapper.findMailboxesById(mailboxIds);
