...
public interface MailboxMapper extends Mapper {
    ...
    /**
     * Return a List of {@link MailboxId} for the given userName and matching the right
     * 
     * @param userName
     * @return right
     * @throws MailboxException
     */
    List<MailboxId> findMailboxes(String userName, Right right) throws MailboxException;
