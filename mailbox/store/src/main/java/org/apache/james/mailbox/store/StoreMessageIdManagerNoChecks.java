...
import static org.apache.james.mailbox.store.StoreMessageIdManager.toMailboxIds;
...
import org.apache.james.mailbox.store.StoreMessageIdManager.MessageMoves;
...
public class StoreMessageIdManagerNoChecks {

    private final MailboxSessionMapperFactory mailboxSessionMapperFactory;
    private final StoreMessageIdManager messageIdManager;

    @Inject
    public StoreMessageIdManagerNoChecks(MailboxSessionMapperFactory mailboxSessionMapperFactory, StoreMessageIdManager messageIdManager) {
    ...
    public void setInMailboxesNoCheck(MessageId messageId, MailboxId targetMailboxId, MailboxSession mailboxSession) throws MailboxException {
        ...
        if (messageMoves.isChange()) {
            messageIdManager.applyMessageMoveNoMailboxChecks(mailboxSession, currentMailboxMessages, messageMoves);
        }
    }
