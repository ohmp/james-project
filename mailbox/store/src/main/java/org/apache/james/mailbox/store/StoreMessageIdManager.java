...
public class StoreMessageIdManager implements MessageIdManager {
    ...
    public DeleteResult delete(MessageId messageId, List<MailboxId> mailboxIds, MailboxSession mailboxSession) throws MailboxException {
        ...
        if (!messageList.isEmpty()) {
            delete(messageIdMapper, messageList, mailboxIds, mailboxSession);
    ...
    public DeleteResult delete(List<MessageId> messageIds, MailboxSession mailboxSession) throws MailboxException {
        ...
        if (!accessibleMessages.isEmpty()) {
            delete(messageIdMapper, messageList, allowedMailboxIds, mailboxSession);
        }
    ...
    public void delete(MessageIdMapper messageIdMapper, List<MailboxMessage> messageList, Collection<MailboxId> inMailboxes, MailboxSession mailboxSession) throws MailboxException {
