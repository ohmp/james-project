 ...
 *
 */
public class MailboxesAndMessagesFeeder {
     ...
     */
    public MailboxesAndMessagesFeeder(MailboxManager mailboxManager) throws MailboxException, UnsupportedEncodingException {
