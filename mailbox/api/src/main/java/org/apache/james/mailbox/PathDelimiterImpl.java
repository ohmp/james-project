...
public class PathDelimiterImpl implements PathDelimiter {

    private final Joiner joiner;
    private final Splitter splitter;
    private final char charDelimiter;

    public PathDelimiterImpl(char charDelimiter) {
        Preconditions.checkArgument(charDelimiter != Character.UNASSIGNED);
    ...
    public final boolean equals(Object obj) {
        if (obj instanceof PathDelimiterImpl) {
            PathDelimiterImpl other = (PathDelimiterImpl) obj;
