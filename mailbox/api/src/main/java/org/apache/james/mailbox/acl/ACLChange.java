...
public class ACLChange {
    private final MailboxACL oldACL;
    private final MailboxACL newACL;

    public ACLChange(MailboxACL oldACL, MailboxACL newACL) {
        this.oldACL = oldACL;
        this.newACL = newACL;
    }
    ...
    public Stream<MailboxACL.Entry> removedEntries() {
        Map<MailboxACL.EntryKey, MailboxACL.Rfc4314Rights> newEntries = newACL.getEntries();
    ...
    public final boolean equals(Object o) {
        if (o instanceof ACLChange) {
            ACLChange aclChange = (ACLChange) o;

            return Objects.equals(this.oldACL, aclChange.oldACL)
                && Objects.equals(this.newACL, aclChange.newACL);
        }
        return false;
    }
