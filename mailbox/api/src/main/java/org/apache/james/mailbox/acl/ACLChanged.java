...
public class ACLChanged {
    ...
    public ACLChanged(MailboxACL oldACL, MailboxACL newACL) {
        this.oldACL = oldACL;
        this.newACL = newACL;
    }
    ...
    public final boolean equals(Object o) {
        if (o instanceof ACLChanged) {
            ACLChanged aclChanged = (ACLChanged) o;

            return Objects.equals(this.oldACL, aclChanged.oldACL)
                && Objects.equals(this.newACL, aclChanged.newACL);
        }
        return false;
    }
