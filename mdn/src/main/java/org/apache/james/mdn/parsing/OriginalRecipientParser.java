...
public class OriginalRecipientParser implements FieldsParser.FieldParser {
    private final TypedValue.Factory factory;

    public OriginalRecipientParser(boolean strict) {
    ...
    public Optional<Field> parse(String value) {
        ...
        return Optional.of(factory.parse(value))
            ...
            .map(typedValue -> new OriginalRecipient(typedValue.getType(), Text.fromRawText(typedValue.getValue())));
    }
