...
```
curl -XPOST http://ip:port/index?task=reIndex
```
...
```
curl -XPOST http://ip:port/index/user/bob@domain.com?task=reIndex
```
...
```
curl -XPOST http://ip:port/index/user/bob@domain.com/mailbox/{mailboxId}?task=reIndex
```
...
```
curl -XPOST http://ip:port/index/user/bob@domain.com/mailbox/{mailboxId}/uid/36?task=reIndex
```
