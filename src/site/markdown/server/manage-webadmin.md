...
```
curl -XPOST http://ip:port/mailboxIndex/user/bob@domain.com?task=reIndex
```
...
```
curl -XPOST http://ip:port/mailboxIndex/user/bob@domain.com/mailbox/{mailboxId}?task=reIndex
```
...
```
curl -XPOST http://ip:port/mailboxIndex/user/bob@domain.com/mailbox/{mailboxId}/uid/36?task=reIndex
```
...
```
curl -XPOST http://ip:port/index/message/{messageId}?task=reIndex
```
