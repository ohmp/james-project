...
public class DuplicatedRecipients {
    ...
    public void simpleMailShouldBeSent() throws Exception {
        ...
        mailboxProbe.createMailbox(MailboxConstants.USER_NAMESPACE, recipient, mailboxName);
        ...
        try (SMTPMessageSender messageSender = SMTPMessageSender.noAuthentication(LOCALHOST_IP, SMTP_PORT, DEFAULT_DOMAIN);
            ...
            messageSender.sendMessage(from, recipient, recipient);
            calmlyAwait.atMost(Duration.ONE_MINUTE).until(messageSender::messageHasBeenSent);
            calmlyAwait.atMost(Duration.ONE_MINUTE).until(() ->
                imapMessageReader.countMessagesInMailbox(recipient, PASSWORD, mailboxName) == 1);
        }
    }
}
