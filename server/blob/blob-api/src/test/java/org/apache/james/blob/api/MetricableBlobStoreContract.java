...
public interface MetricableBlobStoreContract extends BlobStoreContract {
    ...
    default void saveBytesShouldPublishSaveBytesTimerMetrics() {
        ...
        store.save(store.getDefaultBucketName(), BYTES_CONTENT, LowCost).block();
        store.save(store.getDefaultBucketName(), BYTES_CONTENT, LowCost).block();
    ...
    default void saveStringShouldPublishSaveBytesTimerMetrics() {
        ...
        store.save(store.getDefaultBucketName(), STRING_CONTENT, LowCost).block();
        store.save(store.getDefaultBucketName(), STRING_CONTENT, LowCost).block();
    ...
    default void saveInputStreamShouldPublishSaveInputStreamTimerMetrics() {
        ...
        store.save(store.getDefaultBucketName(), new ByteArrayInputStream(BYTES_CONTENT), LowCost).block();
        store.save(store.getDefaultBucketName(), new ByteArrayInputStream(BYTES_CONTENT), LowCost).block();
    ...
    default void readBytesShouldPublishReadBytesTimerMetrics() {
        ...
        BlobId blobId = store.save(store.getDefaultBucketName(), BYTES_CONTENT, LowCost).block();
    ...
    default void deleteBucketShouldPublishDeleteBucketTimerMetrics() {
        ...
        store.save(BucketName.DEFAULT, BYTES_CONTENT, LowCost).block();
        store.save(bucketName, BYTES_CONTENT, LowCost).block();
    ...
    default void deleteShouldPublishDeleteTimerMetrics() {
        ...
        BlobId blobId1 = store.save(store.getDefaultBucketName(), BYTES_CONTENT, LowCost).block();
        BlobId blobId2 = store.save(store.getDefaultBucketName(), BYTES_CONTENT, LowCost).block();
