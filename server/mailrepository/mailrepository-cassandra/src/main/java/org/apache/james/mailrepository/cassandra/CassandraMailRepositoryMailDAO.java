...
public class CassandraMailRepositoryMailDAO {
    ...
    private MailDTO toMail(Row row) {
        ...
        MailImpl mail = new MailImpl(name, sender, recipients);
        mail.setLastUpdated(lastUpdated);
        mail.setErrorMessage(errorMessage);
        mail.setRemoteHost(remoteHost);
        mail.setRemoteAddr(remoteAddr);
        mail.setState(state);
        mail.addAllSpecificHeaderForRecipient(perRecipientHeaders);
        mail.setAttributesRaw(new HashMap<>(toAttributes(rawAttributes)));
    ...
    public class MailDTO {
        ...
        public MailDTO(MailImpl mail, BlobId headerBlobId, BlobId bodyBlobId) {
            this.mail = mail;
        ...
        public final boolean equals(Object o) {
            if (o instanceof MailDTO) {
                ...
                return Objects.equals(this.mail, mailDTO.mail)
        ...
        public final int hashCode() {
            return Objects.hash(mail, headerBlobId, bodyBlobId);
        }
    }
}
