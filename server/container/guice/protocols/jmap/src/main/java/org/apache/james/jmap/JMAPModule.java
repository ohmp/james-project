...
public class JMAPModule extends AbstractModule {
    ...
    public static class RequiredCapabilitiesPrecondition implements ConfigurationPerformer {
        ...
        public void initModule() {
            ...
            Preconditions.checkArgument(mailboxManager.hasCapability(MailboxManager.MailboxCapabilities.RightSearch),
                    "Right Search support in MailboxManager is required by JMAP Module");
