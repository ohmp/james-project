...
package org.apache.james.modules.backends;

import org.apache.james.backends.cassandra.components.CassandraModule;
import org.apache.james.evensourcing.cassandra.CassandraEventStore;
import org.apache.james.evensourcing.cassandra.CassandraEventStoreModule;
...
public class CassandraEventSourcingModule extends AbstractModule {
    ...
    protected void configure() {
        ...
        bind(EventSourcingSystem.class).in(Scopes.SINGLETON);
