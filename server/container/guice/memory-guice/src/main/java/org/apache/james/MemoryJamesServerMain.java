...
public class MemoryJamesServerMain {
    ...
    public static final Module memoryMailboxModules = Modules.combine(
        new MemoryMailboxModule(),
        new QuotaModule());

    public static final Module memoryModule = Modules.combine(
        GuiceJamesServer.protocolsModule(new MemoryMethodsModule()),
        GuiceJamesServer.mailetProcessingModule(new MemoryDequeueDecoratorModule()),
        GuiceJamesServer.commonUtilitiesModule,
        memoryMailboxModules,
