...
public class JpaSampleDeploymentTest {
    private static final Logger logger = LoggerFactory.getLogger(JpaSampleDeploymentTest.class);

    private static final String DEFAULT_JPA_SAMPLE_IMAGE = "linagora/james-jpa-sample:latest";
    private static final String JPA_SAMPLE_IMAGE = "JPA_SAMPLE_IMAGE";
    ...
    private static Future<String> resolveImageName() {
        return CompletableFuture.supplyAsync(() ->
            Optional.ofNullable(System.getenv(JPA_SAMPLE_IMAGE))
                .orElse(DEFAULT_JPA_SAMPLE_IMAGE));
    }
