 ...
 */
public class JPADomainListDAO implements DomainListDAO {
    private static final Logger LOGGER = LoggerFactory.getLogger(JPADomainListDAO.class);
    ...
    public JPADomainListDAO(EntityManagerFactory entityManagerFactory) {
