 ...
 * access.
 */
public class JPARecipientRewriteTableDAO implements RecipientRewriteTableDAO {
    private static final Logger LOGGER = LoggerFactory.getLogger(JPARecipientRewriteTableDAO.class);
