...
class ReindexingRoutesTest {
    ...
    class UserReprocessing {
        ...
        class Validation {
            @Test
            void userlReprocessingShouldFailWithNoTask() {
                when()
            ...
            void userReprocessingShouldFailWithBadTask() {
                when()
                    .post("/index/user/" + USERNAME + "?task=bad")
                .then()
                    .statusCode(HttpStatus.BAD_REQUEST_400)
                    .body("statusCode", is(400))
                    .body("type", is(ErrorResponder.ErrorType.INVALID_ARGUMENT.getType()))
            ...
            void userReprocessingShouldFailWithBadUser() {
                when()
                    .post("/index/user/bad@bad@bad?task=reIndex")
                .then()
                    .statusCode(HttpStatus.BAD_REQUEST_400)
                    .body("statusCode", is(400))
                    .body("type", is(ErrorResponder.ErrorType.INVALID_ARGUMENT.getType()))
        ...
        class TaskDetails {
            ...
            void userReprocessingShouldNotFailWhenNoMail() {
                String taskId = with()
                    .post("/index/user/" + USERNAME + "?task=reIndex")
                    .jsonPath()
                    .get("taskId");
    ...
    class MailboxReprocessing {
        ...
        class Validation {
            ...
            void mailboxReprocessingShouldFailWithNoTask() throws Exception {
                ...
                when()
                    .post("/index/user/" + USERNAME + "/mailbox/" + mailboxId.serialize())
                .then()
                    .statusCode(HttpStatus.BAD_REQUEST_400)
                    .body("statusCode", is(400))
                    .body("type", is(ErrorResponder.ErrorType.INVALID_ARGUMENT.getType()))
            ...
            void mailboxReprocessingShouldFailWithBadTask() throws Exception {
                ...
                when()
                    .post("/index/user/" + USERNAME + "/mailbox/" + mailboxId.serialize() + "?task=bad")
                .then()
                    .statusCode(HttpStatus.BAD_REQUEST_400)
                    .body("statusCode", is(400))
                    .body("type", is(ErrorResponder.ErrorType.INVALID_ARGUMENT.getType()))
            ...
            void mailboxReprocessingShouldFailWithBadUser() throws Exception {
                ...
                when()
                    .post("/index/user/bad@bad@bad/mailbox/" + mailboxId.serialize() + "?task=reIndex")
                .then()
                    .statusCode(HttpStatus.BAD_REQUEST_400)
                    .body("statusCode", is(400))
                    .body("type", is(ErrorResponder.ErrorType.INVALID_ARGUMENT.getType()))
            ...
            void mailboxReprocessingShouldFailWithBadMailboxId() {
                when()
                    .post("/index/user/" + USERNAME + "/mailbox/bad?task=reIndex")
                .then()
                    .statusCode(HttpStatus.BAD_REQUEST_400)
                    .body("statusCode", is(400))
                    .body("type", is(ErrorResponder.ErrorType.INVALID_ARGUMENT.getType()))
            ...
            @Test
            void mailboxReprocessingShouldFailWithNonExistantMailboxId() {
                when()
                    .post("/index/user/" + USERNAME + "/mailbox/36?task=reIndex")
                .then()
                    .statusCode(HttpStatus.BAD_REQUEST_400)
                    .body("statusCode", is(400))
                    .body("type", is(ErrorResponder.ErrorType.INVALID_ARGUMENT.getType()))
        ...
        class TaskDetails {
            ...
            void mailboxReprocessingShouldNotFailWhenNoMail() throws Exception {
                ...
                String taskId = when()
                    .post("/index/user/" + USERNAME + "/mailbox/" + mailboxId.serialize() + "?task=reIndex")
                    .jsonPath()
                    .get("taskId");
    ...
    class MessageReprocessing {
        ...
        class Validation {
            ...
            void messageReprocessingShouldFailWithNoTask() throws Exception {
                ...
                when()
                    .post("/index/user/" + USERNAME + "/mailbox/" + mailboxId.serialize() + "/uid/7")
                .then()
                    .statusCode(HttpStatus.BAD_REQUEST_400)
                    .body("statusCode", is(400))
                    .body("type", is(ErrorResponder.ErrorType.INVALID_ARGUMENT.getType()))
            ...
            void messageReprocessingShouldFailWithBadTask() throws Exception {
                ...
                when()
                    .post("/index/user/" + USERNAME + "/mailbox/" + mailboxId.serialize() + "/uid/7?task=bad")
                .then()
                    .statusCode(HttpStatus.BAD_REQUEST_400)
                    .body("statusCode", is(400))
                    .body("type", is(ErrorResponder.ErrorType.INVALID_ARGUMENT.getType()))
            ...
            void messageReprocessingShouldFailWithBadUser() throws Exception {
                ...
                when()
                    .post("/index/user/bad@bad@bad/mailbox/" + mailboxId.serialize() + "/uid/7?task=reIndex")
                .then()
                    .statusCode(HttpStatus.BAD_REQUEST_400)
                    .body("statusCode", is(400))
                    .body("type", is(ErrorResponder.ErrorType.INVALID_ARGUMENT.getType()))
            ...
            void messageReprocessingShouldFailWithBadMailboxId() {
                when()
                    .post("/index/user/" + USERNAME + "/mailbox/bad/uid/7?task=reIndex")
                .then()
                    .statusCode(HttpStatus.BAD_REQUEST_400)
                    .body("statusCode", is(400))
                    .body("type", is(ErrorResponder.ErrorType.INVALID_ARGUMENT.getType()))
            ...
            void messageReprocessingShouldFailWithNonExistantMailboxId() {
                when()
                    .post("/index/user/" + USERNAME + "/mailbox/36/uid/7?task=reIndex")
                .then()
                    .statusCode(HttpStatus.BAD_REQUEST_400)
                    .body("statusCode", is(400))
                    .body("type", is(ErrorResponder.ErrorType.INVALID_ARGUMENT.getType()))
            ...
            void messageReprocessingShouldFailWithBadUid() {
                when()
                    .post("/index/user/" + USERNAME + "/mailbox/36/uid/bad?task=reIndex")
                .then()
                    .statusCode(HttpStatus.BAD_REQUEST_400)
                    .body("statusCode", is(400))
                    .body("type", is(ErrorResponder.ErrorType.INVALID_ARGUMENT.getType()))
        ...
        class TaskDetails {
            ...
            void messageReprocessingShouldNotFailWhenUidNotFound() throws Exception {
                ...
                String taskId = when()
                    .post("/index/user/" + USERNAME + "/mailbox/" + mailboxId.serialize() + "/uid/1?task=reIndex")
                    .jsonPath()
                    .get("taskId");
            ...
            void messageReprocessingShouldReturnTaskDetailsWhenMail() throws Exception {
                ...
                String taskId = when()
                    .post("/index/user/" + USERNAME + "/mailbox/" + mailboxId.serialize() + "/uid/"
