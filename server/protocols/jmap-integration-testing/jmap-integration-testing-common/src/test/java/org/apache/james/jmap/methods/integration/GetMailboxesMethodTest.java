...
public abstract class GetMailboxesMethodTest {
    ...
    public void getMailboxesShouldReturnAllMailboxesWhenIdsIsNull() throws Exception {
        ...
        .then()
            ...
            .body(ARGUMENTS + ".list.name", hasItems(DefaultMailboxes.INBOX, DefaultMailboxes.OUTBOX, DefaultMailboxes.SENT, DefaultMailboxes.TRASH, DefaultMailboxes.DRAFTS, "myMailbox", "myMailbox2"));
    }
    ...
    public void getMailboxesShouldReturnDefaultMailboxesWhenAuthenticatedUserDoesntHaveAnAccountYet() throws Exception {
        ...
        .then()
            ...
            .body(ARGUMENTS + ".list.name", hasItems(DefaultMailboxes.INBOX, DefaultMailboxes.OUTBOX, DefaultMailboxes.SENT, DefaultMailboxes.TRASH, DefaultMailboxes.DRAFTS));
    }
