...
public class EnqueuedMail {
    ...
    public static class Builder {
        ...
        @FunctionalInterface
        public interface RequireBucketId {
            RequireTimeRangeStart bucketId(BucketedSlices.BucketId bucketId);
        }

        @FunctionalInterface
        public interface RequireTimeRangeStart {
        ...
        private Builder(Mail mail, BucketedSlices.BucketId bucketId, Instant timeRangeStart, Instant enqueuedTime, MailKey mailKey, MailQueueName mailQueueName) {
            this.mail = mail;
    ...
    public static Builder.RequireMail builder() {
        return mail -> bucketId -> timeRangeStart -> enqueuedTime -> mailKey -> mailQueueName ->
            new Builder(mail, bucketId, timeRangeStart, enqueuedTime, mailKey, mailQueueName);
    }
