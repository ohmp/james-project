...
public class FileMailQueueTest implements MailQueueContract, ManageableMailQueueContract, DelayedMailQueueContract, DelayedManageableMailQueueContract {
    ...
    public void browseShouldReturnOrderElements() {
    ...
    @Disabled("JAMES-2299 No snapshot isolation")
    public void concurrentDequeueShouldNotAlterBrowsingWhileIterating() {
