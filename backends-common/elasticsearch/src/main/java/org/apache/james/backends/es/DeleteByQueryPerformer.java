...
public class DeleteByQueryPerformer {
    ...
    @Inject
    public DeleteByQueryPerformer(Client client, @Named("AsyncExecutor") ExecutorService executor, @Named(AliasInjectionConstants.WRITE_ALIAS) AliasName aliasName, TypeName typeName) {
