...
class CassandraBackendTest implements PaggingContract, CassandraSchemaVersionDAOContract, CassandraTypeProviderContract {
    ...
    void setUp(DockerCassandraExtension.DockerCassandra dockerCassandra) {
        cassandra = CassandraCluster.create(
            new CassandraModuleComposite(
                PaggingContract.MODULE,
                CassandraTypeProviderContract.MODULE,
                CassandraSchemaVersionModule.MODULE),
            dockerCassandra.getHost());
        schemaVersionDAO = new CassandraSchemaVersionDAO(cassandra.getConf(), CassandraUtils.WITH_DEFAULT_CONFIGURATION);
    }
    ...
    public CassandraAsyncExecutor executor() {
        return new CassandraAsyncExecutor(cassandra.getConf());
    }

    @Override
    public CassandraSchemaVersionDAO cassandraSchemaVersionDAOTestee() {
