...
public class ListResponseEncoderTest {
    ...
    public void encoderShouldAcceptListResponse() {
        assertThat(encoder.isAcceptable(new ListResponse(MailboxMetaData.Children.HAS_CHILDREN, MailboxMetaData.Selectability.NONE, "name", MailboxConstants.DEFAULT_DELIMITER)))
        .isTrue();
    }
	...
	public void encoderShouldIncludeListCommand() throws Exception {
        encoder.encode(new ListResponse(MailboxMetaData.Children.HAS_CHILDREN, MailboxMetaData.Selectability.NONE, "name", MailboxConstants.DEFAULT_DELIMITER), composer, new FakeImapSession());
