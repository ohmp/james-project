...
public class ExamineRequest extends AbstractMailboxSelectionRequest {
    public ExamineRequest(ImapCommand command, MailboxName mailboxName, boolean condstore, Long lastKnownUidValidity, Long knownModSeq, UidRange[] uidSet, UidRange[] knownUidSet, IdRange[] knownSequenceSet, String tag) {
