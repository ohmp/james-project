...
public class ExamineCommandParser extends AbstractSelectionCommandParser {
    ...
    @Override
    protected AbstractMailboxSelectionRequest createRequest(ImapCommand command, MailboxName mailboxName, boolean condstore, Long lastKnownUidValidity, Long knownModSeq, UidRange[] uidSet, UidRange[] knownUidSet, IdRange[] knownSequenceSet, String tag) {
