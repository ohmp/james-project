...
public class SelectRequest extends AbstractMailboxSelectionRequest {
    ...
    public SelectRequest(ImapCommand command, MailboxName mailboxName, boolean condstore, Long lastKnownUidValidity, Long knownModSeq, UidRange[] uidSet, UidRange[] knownUidSet, IdRange[] knownSequenceSet, String tag) {
