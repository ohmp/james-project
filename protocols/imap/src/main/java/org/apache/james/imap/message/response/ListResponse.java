...
public final class ListResponse extends AbstractListingResponse implements ImapResponseMessage {
    public ListResponse(boolean noInferiors, boolean noSelect, boolean marked, boolean unmarked, boolean hasChildren, boolean hasNoChildren, MailboxName name, PathDelimiter delimiter) {
