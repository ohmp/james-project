...
public class StripAttachmentTest {
    ...
    public static final String TEXT_CALENDAR_CHARSET_UTF_8 = "text/calendar; charset=utf-8";public static final String TEXT_HTML_CHARSET_UTF_8 = "text/html; charset=utf-8";
    @Rule
        ...
        MimeMessage message = MimeMessageBuilder.mimeMessageBuilder()
            .setMultipartWithBodyParts(
                MimeMessageBuilder.bodyPartBuilder()
                    .data("simple text")
                    .build(),
                createAttachmentBodyPart(expectedAttachmentContent, "10.tmp",
                ...
                createAttachmentBodyPart("\u0014\u00A3\u00E1\u00E2\u00E4", "temp.zip",
                    new MimeMessageBuilder.Header(CONTENT_TRANSFER_ENCODING, CONTENT_TRANSFER_ENCODING_VALUE),
                    new MimeMessageBuilder.Header(CONTENT_TYPE, CONTENT_TYPE_DEFAULT)))
            .build();
        ...
        MimeMessage message = MimeMessageBuilder.mimeMessageBuilder()
            .setMultipartWithBodyParts(
                MimeMessageBuilder.bodyPartBuilder()
                    .data("simple text")
                    .build(),
                createAttachmentBodyPart("content", expectedFileName,
                    new MimeMessageBuilder.Header(CONTENT_TRANSFER_ENCODING, CONTENT_TRANSFER_ENCODING_VALUE),
                    new MimeMessageBuilder.Header(CONTENT_TYPE, TEXT_CALENDAR_CHARSET_UTF_8)),
                createAttachmentBodyPart("other content", "11.ical",
                    new MimeMessageBuilder.Header(CONTENT_TRANSFER_ENCODING, CONTENT_TRANSFER_ENCODING_VALUE),
                    new MimeMessageBuilder.Header(CONTENT_TYPE, CONTENT_TYPE_DEFAULT)),
                createAttachmentBodyPart("<p>html</p>", "index.html",
                    new MimeMessageBuilder.Header(CONTENT_TRANSFER_ENCODING, CONTENT_TRANSFER_ENCODING_VALUE),
        ...
        MimeMessage message = MimeMessageBuilder.mimeMessageBuilder()
            .setMultipartWithBodyParts(
                MimeMessageBuilder.bodyPartBuilder()
                    .data("simple text")
                    .build(),
                createAttachmentBodyPart(expectedAttachmentContent, "temp.tmp",
                    new MimeMessageBuilder.Header(CONTENT_TRANSFER_ENCODING, CONTENT_TRANSFER_ENCODING_VALUE),
                    new MimeMessageBuilder.Header(CONTENT_TYPE, CONTENT_TYPE_DEFAULT)),
                createAttachmentBodyPart("\u0014\u00A3\u00E1\u00E2\u00E4", "winmail.dat",
                    new MimeMessageBuilder.Header(CONTENT_TRANSFER_ENCODING, CONTENT_TRANSFER_ENCODING_VALUE),
                    new MimeMessageBuilder.Header(CONTENT_TYPE, CONTENT_TYPE_DEFAULT)))
            .build();
        ...
        MimeMessage message = MimeMessageBuilder.mimeMessageBuilder()
            .setMultipartWithBodyParts(
                MimeMessageBuilder.bodyPartBuilder()
                    .data("simple text")
                    .build(),
                createAttachmentBodyPart(EXPECTED_ATTACHMENT_CONTENT, expectedKey,
                    new MimeMessageBuilder.Header(CONTENT_TRANSFER_ENCODING, CONTENT_TRANSFER_ENCODING_VALUE),
                    new MimeMessageBuilder.Header(CONTENT_TYPE, CONTENT_TYPE_DEFAULT)),
                createAttachmentBodyPart("\u0014\u00A3\u00E1\u00E2\u00E4", "temp.zip",
                    new MimeMessageBuilder.Header(CONTENT_TRANSFER_ENCODING, CONTENT_TRANSFER_ENCODING_VALUE),
